...
export const siteSearchIndex: SiteSearchItem[] = [
  ...
  },
  {
    ...
    href: '/quellen',
    hint: 'Links ASV, LfGA, KomNet, DGUV',
    keywords: ['quelle', 'quellen', 'link', 'offiziell', 'asv', 'lfga', 'landesamt'],
  },
  {
    id: 'asv-aktuelles',
    title: 'Aktuelles & Presse (Arbeitsschutz NRW)',
    href: 'https://www.arbeitsschutz.nrw.de/aktuelles-presse',
    hint: 'Pressemitteilungen ASV NRW',
    keywords: ['aktuelles', 'presse', 'news', 'meldung', 'kontrollaktion'],
    external: true,
  },
  {
    id: 'lfga',
    title: 'LfGA NRW – Landesamt Gesundheit und Arbeitsschutz',
    href: 'https://www.lfga.nrw.de/',
    hint: 'Landesoberbehörde NRW',
    keywords: ['lfga', 'bochum', 'landesamt', 'gesundheit', 'arbeitsschutz'],
    external: true,
  },
  {
    id: 'handsplus',
